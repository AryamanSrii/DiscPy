...
``discpy.ext.tasks`` -- asyncio.Task helpers
====================================================
...
A simple background task in a :class:`~discpy.ext.commands.Cog`:

.. code-block:: python3

    from discpy.ext import tasks, commands
...
.. attributetable:: discpy.ext.tasks.Loop

.. autoclass:: discpy.ext.tasks.Loop()
    :members:
...
.. autofunction:: discpy.ext.tasks.loop
